...
import com.jim.gadsleaderboard.adapters.SkillLeadersAdapter;
import com.jim.gadsleaderboard.models.SkillLeaders;
import com.jim.gadsleaderboard.viewModel.SkillLeadersViewModel;
...
public class SkillIQLeadersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        skillLeadersViewModel.getSkillLeadersLiveData().observe(this, new Observer<List<SkillLeaders>>() {
            @Override
